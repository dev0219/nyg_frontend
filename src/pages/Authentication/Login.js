...
import { loginToken } from "helpers/url_helper"
...
class Login extends Component {
  ...
  handleValidSubmit = async (event, values) => {
    ...
    try {
      ...
      const submit_response = await fetch(loginToken, requestOptions)
                  ...
                  <CardBody className="pt-0">
                    ...
                    <div className="p-2">
                      ...
                      >
                        ...
                        <a href="" onClick={this.singup} style={{float:"right",marginTop:"20px"}}>
                          Sign up
                        </a>
                      </AvForm>
                    </div>
