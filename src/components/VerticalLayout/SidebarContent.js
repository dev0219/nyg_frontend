            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="/machineLocation">Location</Link>
                  </li>
                  <li>
                    <Link to="/machineGroup">Group</Link>
                  </li>
                  <li>
                    <Link to="/machineStatus">Status</Link>
                  </li>
                  <li>
                    <Link to="/machineType">Type</Link>
                  </li>
                  <li>
                    <Link to="/machineBrand">Brand</Link>
                  </li>
                </ul>
              </li>
              {/*<li>
